            ...
            <div className="row">
              <div className="col-md-5">
                <div className="accWhiteBoxCol">
                  ...
                  <div class="usr-pro-view">
                    <ul>
                      <li>
                        <div class="pro-vw-box">
                          <div class="pro-vw-lbl">User Name</div>
                          <div class="pro-vw-dsply">deepaktaneja1993</div>
                        </div>
                      </li>
                      <li>
                        <div class="pro-vw-box">
                          <div class="pro-vw-lbl">First Name</div>
                          <div class="pro-vw-dsply">Mark</div>
                        </div>
                      </li>
                      <li>
                        <div class="pro-vw-box">
                          <div class="pro-vw-lbl">Surname</div>
                          <div class="pro-vw-dsply">John</div>
                        </div>
                      </li>
                      <li>
                        <div class="pro-vw-box">
                          <div class="pro-vw-lbl">Type</div>
                          <div class="pro-vw-dsply">Poojari</div>
                        </div>
                      </li>
                      <li>
                        <div class="pro-vw-box">
                          <div class="pro-vw-lbl">Email</div>
                          <div class="pro-vw-dsply">
                      ...
                      <li>
                        <div class="pro-vw-box">
                          <div class="pro-vw-lbl">Phone</div>
                          <div class="pro-vw-dsply">
                            <Link to="tel:(123)-456-7890-8">(123)-456-7890-8</Link>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="pro-vw-box">
                          <div class="pro-vw-lbl">Gender</div>
                          <div class="pro-vw-dsply">Male</div>
                        </div>
                      </li>
                    </ul>
                  </div>
                ...
                <div className="accWhiteBoxCol">
                  ...
                  <div className="usrSclInfo">
                    <ul className="userSclOptions">
                      ...
                      <li className="lnkdnColor">
                        <Link to="#">
                          <i className="fa fa-linkedin" aria-hidden="true"></i>
                          <span>Linkedin</span>
                        </Link>
                      </li>
                      <li className="wtspColor">
                        <Link to="#">
                          <i className="fa fa-whatsapp" aria-hidden="true"></i>
                          <span>whatsapp</span>
                        </Link>
              ...
              <div className="col-md-5">
                <div className="accProfileSidebar">
                  <div className="accOvrvwCountsRow">
                    <div className="row g-4">
                      <div className="col-md-6">
                        <div className="accOvrvwCountsCol accOvrvwCountsBg1">
                          <div className="accOvrvwCountsImg">
                            <span>
                              <img src="images/donationIcon1.png" />
                            </span>
                          </div>
                          <div className="accOvrvwCountsInfo text-center">
                            <h3><sup><small>$</small></sup>256</h3>
                            <h4>Donations</h4>
                          </div>
                        </div>
                      </div>
                      <div className="col-md-6">
                        <div className="accOvrvwCountsCol accOvrvwCountsBg4">
                          <div className="accOvrvwCountsImg">
                            <span>
                      ...
                      <div className="col-md-6">
                        <div className="accOvrvwCountsCol accOvrvwCountsBg5">
                          <div className="accOvrvwCountsImg">
                            <span>
                      ...
                      <div className="col-md-6">
                        <div className="accOvrvwCountsCol accOvrvwCountsBg8">
                          <div className="accOvrvwCountsImg">
                            <span>
