      ...
      <article className="accntContentBlock wrapper py-60">
        <div className="container">
          ...
          <div className="accntTableCol">
            <div className="accntTableRow common-table">
              <Table striped bordered hover responsive>
                <thead>
                  <tr>
                    <th className="smallTableColumn">#</th>
                    <th className="largeTableColumn">Date</th>
                    <th className="mediumTableColumn">Name</th>
                    <th className="largeTableColumn">Email</th>
                    <th className="largeTableColumn">Phone</th>
                    <th className="xlargeTableColumn">Message</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td align="center"><Link to="mailto:>mark@example.com">mark@example.com</Link></td>
                    <td align="center"><Link to="tel:(123)-456-7890-8">(123)-456-7890-8</Link></td>
                    <td><p>Temple is a place where Hindu worship our Ram, Shiva, Vishnu, Krishna etc.</p></td>
                    <td align="center">
                      <div className="tbl-actn">
                        <Link to="#" className="dltbtn">
                          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M20.25 5.25L3.75 5.25001" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M9.75 9.75V15.75" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M14.25 9.75V15.75" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <tr>
                    ...
                    <td align="center"><Link to="mailto:jacob@example.com">jacob@example.com</Link></td>
                    <td align="center"><Link to="tel:(123)-456-7890-8">(123)-456-7890-8</Link></td>
                    <td><p>Temple is a place where Hindu worship our Ram, Shiva, Vishnu, Krishna etc.</p></td>
                    <td align="center">
                      <div className="tbl-actn">
                  ...
                  <tr>
                    ...
                    <td align="center"><Link to="mailto:larry@example.com">larry@example.com</Link></td>
                    <td align="center"><Link to="tel:(123)-456-7890-8">(123)-456-7890-8</Link></td>
                    <td><p>Temple is a place where Hindu worship our Ram, Shiva, Vishnu, Krishna etc.</p></td>
                    <td align="center">
                      <div className="tbl-actn">
                  ...
                  <tr>
                    ...
                    <td align="center"><Link to="mailto:james@example.co">james@example.com</Link></td>
                    <td align="center"><Link to="tel:(123)-456-7890-8">(123)-456-7890-8</Link></td>
                    <td><p>Temple is a place where Hindu worship our Ram, Shiva, Vishnu, Krishna etc.</p></td>
                    <td align="center">
                      <div className="tbl-actn">
