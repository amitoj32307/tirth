...
function CulturalSignificanceDetail() {
  return (
    <section>
      <Header/>
              ...
              <h2>Buddhism</h2>
                <div className="breadcrumbsCol">
                  <Breadcrumb>
                    ...
                    <Breadcrumb.Item href="/cultural-significance-list">All Cultural Significance</Breadcrumb.Item>
                    <Breadcrumb.Item active>Buddhism</Breadcrumb.Item>
                  </Breadcrumb>
                </div>
            </div>
      ...
      <article className="poojaDetailBlock lightGradientBg wrapper py-80">
        <div className="container">
          <div className="poojaTopOuter">
              <div className="poojaTopMedia" style={{backgroundImage: `url("images/buddhismBig.jpg")`}}>
                  ...
                  <div className="row g-4">
                    <div className="col-md-4">
                      <div className="poojaDtlImgCol">
                        <div className="poojaDtlImg" style={{backgroundImage: `url("images/culturalSignificance1.jpg")`}}></div>
                      </div>
                    </div>
                    <div className="col-md-4">
                      <div className="poojaDtlImgCol">
                        <div className="poojaDtlImg" style={{backgroundImage: `url("images/culturalSignificance2.jpg")`}}></div>
                      </div>
                    </div>
                    <div className="col-md-4">
                      <div className="poojaDtlImgCol">
                        <div className="poojaDtlImg" style={{backgroundImage: `url("images/culturalSignificance3.jpg")`}}></div>
                      </div>
                    </div>
                  </div>
                </div>
...
export default CulturalSignificanceDetail;