          ...
          <div className="hdrRight">
            ...
            <div class="hdr-user">
              <Dropdown className="user-drop">
                <Dropdown.Toggle variant="success" id="dropdown-basic" className="user-drop-menu">
                  <span>
                    <img src="images/yeshwantPandit1.jpg" id="imgProfiles" />
                  </span>
                  <h3>Yeshvant Parsad</h3>
                  <p>Temple Member</p>
                </Dropdown.Toggle>
                <Dropdown.Menu className="user-dropdown-menu">
                  <Dropdown.Item href="poojari-dashboard">
                  ...
                  <Dropdown.Item href="transactions">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <Dropdown.Item href="close-account">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <Dropdown.Item href="signup">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path d="M16.3135 8.0625L20.2499 12L16.3135 15.9375" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                      <path d="M9.75 12H20.2472" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                      <path d="M9.75 20.25H4.5C4.30109 20.25 4.11032 20.171 3.96967 20.0303C3.82902 19.8897 3.75 19.6989 3.75 19.5V4.5C3.75 4.30109 3.82902 4.11032 3.96967 3.96967C4.11032 3.82902 4.30109 3.75 4.5 3.75H9.75" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"></path>
                    </svg>
                    <span>Sign Out</span>
                  </Dropdown.Item>
                </Dropdown.Menu>
