    ...
    <section>
      ...
      <article className="accntContentBlock wrapper py-60">
        <div className="container">
          ...
          <div className="accSettingCol">
            <div className="row">
              <div className="col-md-8">
                <div className="accWhiteBoxCol">
                  <div className="accUserForm">
                    <div class="sdbrHdng">
                    ...
                    <form class="formStyle">
                      <div class="row g-4">
                        <div class="col-12">
                          <div className="profileChangeCol">
                            <div className="row d-sm-flex align-items-center justify-content-center">
                              <div className="col">
                                <div className="prflChaneGroup d-flex align-items-center">
                                  <span style={{backgroundImage: `url("images/yeshwantPandit1.jpg")`}}></span>
                              ...
                              <div className="col-auto">
                                <div className="pflEml">
                                  <p><strong>Email:</strong> <Link to="mailto:jenny.wilson@gmail.com">jenny.wilson@gmail.com</Link></p>
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="col-12">
                          <button type="submit" class="btn btnCommon btnRadiusNone">Save Changes</button>
                        </div>
                      </div>
                    </form>
                  </div>
                </div>
                <div className="accWhiteBoxCol mt-4">
                  <div className="accUserForm">
                    <div class="sdbrHdng">
                ...
                <div className="accWhiteBoxCol mt-4">
                  <div className="accUserForm">
                    ...
                    <form class="formStyle">
                      <div class="row g-4">
                        <div class="col-12">
                          <label for="currentPssFld" class="form-label">Current Password</label>
                          <div className="form-group">
                            <input type="password" class="form-control" id="currentPssFld" placeholder="" />
                            <i>
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"></path>
                              </svg>
                            </i>
                          </div>
                        </div>
                        <div class="col-12">
                          <label for="newPssFld" class="form-label">New Password</label>
                          <div className="form-group">
                            <input type="password" class="form-control" id="newPssFld" placeholder="" />
                            <i>
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 12C1 12 5 4 12 4C19 4 23 12 23 12C23 12 19 20 12 20C5 20 1 12 1 12Z" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"></path>
                        ...
                        <div class="col-12">
                          <label for="confirmPssFld" class="form-label">Confirm Password</label>
                          <div className="form-group">
                            <input type="password" class="form-control" id="confirmPssFld" placeholder="" />
                            <i>
                              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 12C1 12 5 4 12 4C19 4 23 12 23 12C23 12 19 20 12 20C5 20 1 12 1 12Z" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M12 15C13.6569 15 15 13.6569 15 12C15 10.3431 13.6569 9 12 9C10.3431 9 9 10.3431 9 12C9 13.6569 10.3431 15 12 15Z" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"></path>
