              ...
              <Table striped bordered hover responsive>
                <thead>
                  <tr>
                    ...
                    <th className="largeTableColumn">Reference ID</th>
                    <th className="xlargeTableColumn">Name Of Service</th>
                    <th className="smallTableColumn">Price</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td align="center">RD109972035328362000</td>
                    <td align="center">
                      <div className="tblSrvcCol d-flex align-items-center">
                        <div className="tblSrvcImgDiv">
                          <div className="tblSrvcImg" style={{backgroundImage: `url("images/santoshiPuja.jpg")`}}></div>
                        </div>
                        <div className="tblSrvcTtl">Santoshi Puja</div>
                      </div>
                    </td>
                    <td align="center">
                      <span className="tblPrice">$20.49</span>  
                    </td>
                    <td>
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <div className="tblSrvcCol d-flex align-items-center">
                        <div className="tblSrvcImgDiv">
                          <div className="tblSrvcImg" style={{backgroundImage: `url("images/vishnuPuja.jpg")`}}></div>
                        </div>
                        <div className="tblSrvcTtl">Durga Puja</div>
                      </div>
                    </td>
                    <td align="center">
                      <span className="tblPrice">$20.49</span>  
                  ...
                  <tr>
                    ...
                    <td align="center">
                      <div className="tblSrvcCol d-flex align-items-center">
                        <div className="tblSrvcImgDiv">
                          <div className="tblSrvcImg" style={{backgroundImage: `url("images/kaliPuja.jpg")`}}></div>
                        </div>
                        <div className="tblSrvcTtl">Kali Puja</div>
                      </div>
                    </td>
                    <td align="center">
                      <span className="tblPrice">$20.49</span>  
